...
function end(num1,num2,num3){
        ...
        document.getElementById('item'+num1).style.background = '#9c8f7f'
        document.getElementById('item'+num2).style.background = '#9c8f7f'
        document.getElementById('item'+num3).style.background = '#9c8f7f'
